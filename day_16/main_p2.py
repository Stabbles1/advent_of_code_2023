...
def solve(lines):
    ...
    for x in range(0, len(lines)):
        ...
        travel(grid, 0, x, 1, 0)
        this_energy_level = energy_level(grid)
        highest_energy_level = max(highest_energy_level, this_energy_level)
